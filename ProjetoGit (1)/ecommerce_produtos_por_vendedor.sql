...
CREATE TABLE `produtos_por_vendedor` (
  ...
  PRIMARY KEY (`Terceiro_idTerceiro`,`Produtos_idProdutos`),
  KEY `Produtos_idProdutos` (`Produtos_idProdutos`),
  CONSTRAINT `produtos_por_vendedor_ibfk_1` FOREIGN KEY (`Terceiro_idTerceiro`) REFERENCES `terceiro_vendedor` (`idTerceiro`),
  CONSTRAINT `produtos_por_vendedor_ibfk_2` FOREIGN KEY (`Produtos_idProdutos`) REFERENCES `produtos` (`idProdutos`)
